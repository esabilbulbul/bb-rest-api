...
import apicallbacks.InventoryCallbacks;
...
public class UI implements jeiRestInterface
{
                                                 ...
                                                 ) throws Exception
    {
        ...
        try
        {
            ...
            mrcList = bb.app.account.AccountMisc.getListOfMerchants4User(gem, gUserId);
                                         ...
                                         ) throws Exception
    {
        ...
        try
        {
            ...
            summary.currentMonth.dayAvgs = bb.app.account.AccountMisc.calculateSummaryTargetMonthDayAverages(gem, acc.uid, baseCurrency, targetCurrency, "-1", sTargetMonth);
                                            ...
                                            ) throws Exception
    {
        ...
        try
        {
            ...
            boolean rc = bb.app.account.AccountMisc.isEODAdded(gem, pAccountId, sDate);
            ...
            {
                rc = bb.app.account.AccountMisc.updateEOD(gem, pAccountId, sDate, sTot);
            }
                                          ...
                                          ) throws Exception
    {
        try
        {
            ...
            countyCodes = InventoryOps.getCountyCodes(em, sCountryCode, sCityCode);
                                          ...
                                          ) throws Exception
    {
        try
        {
            ...
            postCodes = InventoryOps.getPostCodes(em, sCountryCode, sCityCode);
    ...
    */
                                   ...
                                   ) throws Exception
    {
        ...
        try
        {
            ...
            countryCodes = InventoryOps.getCountryCodes(em);
            ...
            cityCodes = InventoryOps.getCityCodes(em, psCountry);
                                     ...
                                     ) throws Exception
    {
        ...
        try
        {
            ...
            summary = bb.app.account.AccountMisc.calculateSummary(gem, lAccId, mrcPrefs.MerchantName, baseCurrency, targetCurrency, -1, -1, -1, iYearEarningLength);//-1 all in
                                             ...
                                             ) throws Exception
    {
        ...
        try
        {
            ...
            AllEarningStats = bb.app.account.AccountMisc.calculateSummary_YearEarningOnly(gem, lAccId, mrcPrefs.MerchantName, baseCurrency, targetCurrency, -1, -1, -1, iYearEarningLength);//-1 all in
    ...
    @Produces(MediaType.JSON_PLUS)
    @Token(VerificationType.MUST)
    @Callback(type = ThreadActionType.AFTER, source = "newInventoryTransaction", targetClass="apicallbacks.InventoryCallbacks", targetMethod = "newInventoryTransaction_Callback")
    public ssoAPIResponse newInventoryTransaction(  @PathParam("aid")                          String pAccId,
                                                    ...
                                                    @PathParam("qnt")                          String psQuantity,
                                                    @PathParam("qtp")                          String psQuantityType,
                                                    @PathParam("eprc")                         String psEntryPrice,
                                                    @PathParam("dso")                          String psDiscount,
                                                    @PathParam("tx")                           String psTax,
                                                    @PathParam("sprc")                         String psSalesPrice,
                                                 ...
                                                 ) throws Exception
    {
        try
        {
            ...
            long InvTxnId = 0;
            InvTxnId = InventoryOps.save2Inventory( gem, 
                                                    gUserId, 
                                                    lAccId, 
                                                    psLang, 
                                                    psCountry, 
            ...
            {
                rsp.Response = "ok";
                rsp.callbackId = Long.toString(InvTxnId);
            }
                                                 ...
                                                 ) throws Exception
    {
        try
        {
            ...
            params = InventoryOps.getItemLastEntryInfo(gem, lAccId, psItemCode);
                                             ...
                                             ) throws Exception
    {
        try
        {
            ...
            aItemsFound = InventoryOps.searchInventoryItems(gem, lAccId, psKeyword);
    ...
    @Produces(MediaType.JSON_PLUS)
    @Token(VerificationType.MUST)
    public ssoAPIResponse searchInventory(  @PathParam("aid")                          String pAccId,
                                            @PathParam("lng")                          String psLang,
                                            @PathParam("cnt")                          String psCountry,
                                            @PathParam("sid")                          String psSessionId,
                                            @PathParam("ip")                           String psIP,
                                         ...
                                         ) throws Exception
    {
        try
        {
            ...
            balances = InventoryOps.getInventoryBalanceByKeyword(gem, gUserId, psKeyword);
